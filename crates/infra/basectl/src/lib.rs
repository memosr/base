...
pub use rpc::{
    ...
    ElReachabilityOutcome, ElReachabilityResponse, ElReachabilityStage, GameDetails,
    GameListFilter, GameStatus, GameSummary, GamesClient, InitialBacklog, L1BlockInfo,
    ...
    RawInfoReport, RawPeerCounts, RawPeersReport, SEQUENCER_ACTIVE_RPC_TIMEOUT,
    SnarkPlonkProofBytes, SubmittedProof, SubmitterKey, SyncStatusReport, TelemetryApiError,
